...
import static com.github.securityfilter.AssertUserEqualsHttpTest.AssertUserEqualsHttpTes1t.openConnection;
import static com.github.securityfilter.AssertUserEqualsHttpTest.AssertUserEqualsHttpTes1t.readInputToBytes;
...
public class AssertUserEqualsHttpTest {
    ...
    public void test() throws IOException {
        ...
        for (int port = 85; port < 90; port++) {
            list.add(new AssertUserEqualsHttpTes1t(port));
        }

        list.forEach(e -> e.server.getBootstrapFuture().syncUninterruptibly());

        for (AssertUserEqualsHttpTes1t httpTest : list) {
...
//                            return;
    ...
    public static class AssertUserEqualsHttpTes1t {
        ...
        public AssertUserEqualsHttpTes1t(int port) {
            this.port = port;
